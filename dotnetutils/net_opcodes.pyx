...
cdef NET_OPCODE_DB = {
    ...
    0x37: OpCode(name="blt.un.s", operand_count=1, is_branch=True, nstack=-2, pstack=2),
    ...
    0x8F: OpCode(name="ldelema", operand_count=4, has_token_argument=True, nstack=-1, astack=1, pstack=2),
    ...
    0xE0: OpCode(name="conv.u", operand_count=0, astack=1, pstack=1),
    0xFE00: OpCode(name="arglist", operand_count=0, is_two_byte_opcode=True, astack=1, nstack=1),
    ...
    0xFE11: OpCode(name="endfilter", operand_count=0, is_two_byte_opcode=True, pstack=1, nstack=-1),
    ...
    0xFE07: OpCode(name="ldvirtftn", operand_count=4, has_token_argument=True, is_two_byte_opcode=True, nstack=0, astack=1, pstack=1),
