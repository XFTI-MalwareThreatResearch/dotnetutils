...
class EmulatorSecurityException(DotNetUtilsException):
    def __init__(self, instr_string='unknown'):
        Exception.__init__(self,
                           "A .NET instruction could not be emulated for security purposes: {}".format(instr_string))
...
class EmulatorMethodBreakException(DotNetUtilsException):
    def __init__(self):
        Exception.__init__(self,
                           'This exception is for internal use only.  Method execution has been stopped before ret instruction.')
